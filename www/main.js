(self["webpackChunklinkshortener"] = self["webpackChunklinkshortener"] || []).push([["main"],{
...
/* harmony import */ var _guards_loginPageAuth_guard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./guards/loginPageAuth.guard */ 2310);
...
const routes = [
    ...
    {
        path: 'login',
        canActivate: [_guards_loginPageAuth_guard__WEBPACK_IMPORTED_MODULE_0__.LoginGuard],
    ...
    {
        path: 'user/list',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_user_list_list_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/user/list/list.module */ 8337)).then(m => m.ListPageModule)
    },
    {
        path: 'link/list',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_link_list_list_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/link/list/list.module */ 1960)).then(m => m.ListPageModule)
    },
    {
        path: ':linkHash',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_link_details_details_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/link/details/details.module */ 7561)).then(m => m.DetailsPageModule)
    },
    {
        path: 'link/create',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_link_create_create_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/link/create/create.module */ 9357)).then(m => m.CreatePageModule)
    },
];
...
/* harmony import */ var _auth_guards_token_intercecptor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth/guards/token.intercecptor */ 1406);
    ...
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__.HTTP_INTERCEPTORS,
                useClass: _auth_guards_token_intercecptor__WEBPACK_IMPORTED_MODULE_2__.TokenInterceptor,
                multi: true
            }
        ],
...
/***/ 1406:
/*!***************************************************!*\
  !*** ./src/app/auth/guards/token.intercecptor.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let TokenInterceptor = class TokenInterceptor {
    ...
    intercept(request, next) {
        ...
        return next.handle(request).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(error => {
            ...
            else if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpErrorResponse && (error.status === 401 || error.status == 422)) {
    ...
    handle401Error(request, next) {
        if (!this.isRefreshing) {
            ...
            return this.authService.refreshToken().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.switchMap)((token) => {
                this.isRefreshing = false;
            ...
            return this.refreshTokenSubject.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.filter)(token => token != null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.switchMap)(access_token => {
...
TokenInterceptor = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
...
/***/ 2310:
/*!***********************************************!*\
  !*** ./src/app/guards/loginPageAuth.guard.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ 6736);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ 5304);
...
let AuthService = class AuthService {
    ...
    login(loginDict) {
        return this.http.post(this.baseUrl + '/auth/login', loginDict)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_0__.tap)(tokens => {
            this.doLoginUser(loginDict.username, tokens);
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.mapTo)(true), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(error => {
            alert(error.error);
    ...
    logout() {
        ...
        }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_0__.tap)(() => this.doLogoutUser()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.mapTo)(true), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(error => {
            alert(error.error);
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(false);
        }));
    }
